...
import com.example.myapptestmsapps.Models.NewApiResponse;
...
public class RequestManager {
    ...
    public void getNewsHeadlines(OnFetchDataListener listener, String category, String query)
    {
        ...
        Call<NewApiResponse> call = callNewsApi.callHeadlines("us", category, query, context.getString(R.string.api_kay));
        ...
        try{
            call.enqueue(new Callback<NewApiResponse>() {
                ...
                public void onResponse(Call<NewApiResponse> call, Response<NewApiResponse> response) {
                    ...
                    listener.onFetchData(response.body().getArticles(), response.message()); //41min
                }
